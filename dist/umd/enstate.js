(function (global, factory) {
  ...
  (factory((global.enstate = {}),global.React));
  ...
  */
  ...
  var StateProvider = function (_React$Component) {
      inherits(StateProvider, _React$Component);

      function StateProvider(props) {
          classCallCheck(this, StateProvider);

          var _this = possibleConstructorReturn(this, (StateProvider.__proto__ || Object.getPrototypeOf(StateProvider)).call(this, props));
  ...
  var Container = function (_React$Component) {
      ...
      function Container() {
          ...
          return _ret = (_temp = (_this = possibleConstructorReturn(this, (_ref = Container.__proto__ || Object.getPrototypeOf(Container)).call.apply(_ref, [this].concat(args))), _this), _this.renderChildWithContext = function (context) {
      ...
      createClass(Container, [{
          ...
          value: function transformSelectors(_ref2) {
              ...
              return Object.entries(this.props.selectors).reduce(function (actions, _ref3) {
                  ...
                  return _extends({}, actions, defineProperty({}, key, function () {
